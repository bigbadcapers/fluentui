  ...
  public render(): JSX.Element {
    return (
      <div>
        ...
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 16, imageFileType: 'png' })} />
        <h3>Size 20 archive icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 20, imageFileType: 'png' })} />
        <h3>Size 32 audio icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 32, imageFileType: 'png' })} />
        <h3>Size 40 code icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: '.fluid', size: 40, imageFileType: 'png' })} />
        <h3>Size 48 csv icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 48, imageFileType: 'png' })} />
        <h3>Size 64 model icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 64, imageFileType: 'png' })} />
        <h3>Size 96 docx icon as .png</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 96, imageFileType: 'png' })} />
        <h3>Size 16 dotx icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 16, imageFileType: 'svg' })} />
        <h3>Size 20 email icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 20, imageFileType: 'svg' })} />
        <h3>Size 32 exe icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 32 })} />
        <h3>Size 40 script icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 40 })} />
        <h3>Size 48 html icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 48 })} />
        <h3>Size 64 mpp icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'loop', size: 64 })} />
        <h3>Size 96 link icon as .svg</h3>
        <Icon {...getFileTypeIconProps({ extension: 'fluid', size: 96 })} />
